...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/E5WfzegYD/model.json',modelLoaded);
...
if(error){console.error(error);}else{console.log(results)
